...
public spaces. Examples of representing our community include using an official e-mail address, posting via an official social
media account, or acting as an appointed representative at an online or offline event.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement
by opening a confidential issue in the [patchpanel repository](https://github.com/STARTcloud/patchpanel/issues) or by contacting the
project maintainers directly via email. All complaints will be reviewed and investigated promptly and fairly.
